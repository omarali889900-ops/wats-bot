...
// ═══════════════════════════════════════════
const CLINIC = {
  name:    'المركز الملكي للأسنان دكتور محمد جسن رشاد',
...
- حشو تجميلي
- طربوش 
- قص و تجميل اللثه مع العضم للسن الواحد
- زراعة الفك الكامل
`;
...
الأسعار (لا تذكريها إلا إذا سأل المريض عن السعر تحديداً وتعطي سعر الخدمه البيسأل عليها):
${PRICES_LIST}
